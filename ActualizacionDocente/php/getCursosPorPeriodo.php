...
$sql = "SELECT curso.idCurso,
            ...
            curso.objetivo,
            curso.duracion,
            concat_ws(' - ', DATE_FORMAT(curso.fechaInicio, '%d de %M'), DATE_FORMAT(curso.fechaFin, '%d de %M del %Y')) as fecha,
            DATE_FORMAT(curso.fechaFin, '%d de %M del %Y') as fechaFin,
            DATE_FORMAT(curso.fechaInicio, '%d de %M') as fechaInicio,
            concat_ws(' a ',curso.horaInicio,curso.horaFin) as horario,
            curso.fechaFin as ff,
            curso.validado,
            curso.periodo
