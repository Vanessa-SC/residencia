...
app.service('periodoService', function ($q, $http) {
	...
	return {
		getPeriodo: function () {
			return $http({
				method: 'GET',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/periodoActual.php'
...
app.service('fechaService', function ($q, $http) {
	...
	return {
		getFecha: function () {
			return $http({
				method: 'GET',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/fecha.php'
			}).then(function successCallback(response) {
...
app.service('asistenciaService', function ($http, $q) {
	...
	return {
		existe: function (idc) {
			return $http({
				method: 'POST',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getRegistroAsistenciaCurso.php',
				headers: {
...
app.controller('loginCtrl', function ($scope, $http, $location, user, $timeout) {
	...
	$scope.login = function () {
		...
		$http({
				url: 'http://localhost/Residencia/ActualizacionDocente/server.php',
				method: 'POST',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
...
app.controller('programaCtrl', function ($scope, $http, $location, $filter, user, curso, periodoService, $timeout) {
	...
	$scope.getCursos = function () {
		$http({
			method: 'GET',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getCursos.php'
		}).then(function successCallback(response) {
	...
	$scope.getDepartamentos = function () {
		$http({
			method: 'GET',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getDepartamentos.php'
		}).then(function successCallback(response) {
	...
	$scope.getInstructores = function () {
		$http({
			method: 'GET',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getInstructores.php'
		}).then(function successCallback(response) {
	...
	$scope.getListaDocumentosSubidos = function () {
		...
		$timeout(function () { //delay para la ejecución de la consulta
			if (idCurso != undefined) {
				...
				$http({
					method: 'POST',
					url: 'http://localhost/Residencia/ActualizacionDocente/php/getDocsCurso.php',
					headers: {
						'Content-Type': 'application/x-www-form-urlencoded'
					},
	...
	$scope.getCursoAct = function () {
		...
		if ($scope.idCurso != "") {
			$http({
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getCursoAct.php',
				method: 'POST',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.getDoc = function () {
		...
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getDocumentosCurso.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
	...
	$scope.crearCurso = function (datos) {
		...
		if (
			...
			$http({
				method: 'POST',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/crearCursoC.php',
				headers: {
	...
	$scope.actualizarCurso = function (datos) {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/actualizarCursoC.php',
			headers: {
				'Content-Type': 'application/json'
			},
			data: JSON.stringify(datos)
	...
	$scope.deleteCurso = function (id) {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/deleteCurso.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
			data: 'idCurso=' + id
	...
	$scope.addComment = function (documento, idDoc, idCurso) {
		...
		if (documento.comentario != undefined) {
			$http({
				method: 'POST',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/addComentario.php',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.validarDocumento = function (val, id) {
		if (curso.getID() != undefined) {
			$http({
				method: 'POST',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/validarDocumentoCurso.php',
				headers: {
					'Content-type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.validacionDocumentos = function () {
		if (curso.getID() != undefined) {
			$timeout(function () {
				$http({
					method: 'POST',
					url: 'http://localhost/Residencia/ActualizacionDocente/php/getValidacionDocumentos.php',
					headers: {
						'Content-type': 'application/x-www-form-urlencoded'
					},
					data: 'idc=' + curso.getID()
					...
					if (response.data.docs_status == 'invalidos' && $scope.infoCurso.validado == 'SI') {
						$http({
							method: 'POST',
							url: 'http://localhost/Residencia/ActualizacionDocente/php/validarCurso.php',
							headers: {
								'Content-type': 'application/x-www-form-urlencoded'
							},
...
app.controller('constanciasCtrl', function ($scope, $http, $location, user, periodoService, curso, constancia, fechaService) {
	...
	$scope.getConstancias = function () {
		$http({
			method: 'GET',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getConstancias.php'
		}).then(function successCallback(response) {
	...
	$scope.getConstanciasPeriodoActual = function () {
		$scope.periodoActual = periodoService.getPeriodo()
			.then(function (response) {
				...
				$http({
					url: 'http://localhost/Residencia/ActualizacionDocente/php/getConstanciasPeriodoActual.php',
					method: 'POST',
					headers: {
						'Content-Type': 'application/json'
					},
	...
	$scope.crearConstancia = function () {
		...
		if ($scope.constancia.curso.folio != "") {
			if ($scope.constancia.participante.nombre != "Todos los participantes aprobados") {
				...
				$http({
					method: 'POST',
					url: 'http://localhost/Residencia/ActualizacionDocente/php/generarConstancia.php',
					headers: {
						'Content-Type': 'application/json'
					},
					data: JSON.stringify(datos)
				...
				$http({
					method: 'POST',
					url: 'http://localhost/Residencia/ActualizacionDocente/php/generarConstanciasCurso.php',
					headers: {
						'Content-Type': 'application/json'
					},
					data: JSON.stringify(datos)
...
app.controller('instructoresCtrl', function ($scope, $http, $location, user, periodoService, instructor, $timeout) {
	...
	$scope.agregarInstructor = function (datos) {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/agregarInstructor.php',
			headers: {
				'Content-Type': 'application/json'
			},
			data: JSON.stringify(datos)
	...
	$scope.deleteInstructor = function (id, nombreInstructor) {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/deleteInstructor.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
	...
	$scope.getInstructorAct = function () {
		...
		if (instructor.getID() != "") {
			$http({
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getInstructorAct.php',
				method: 'POST',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.actualizarInstructor = function () {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/actualizarInstructor.php',
			headers: {
				'Content-Type': 'application/json'
			},
...
app.controller('encuestasCtrl', function ($scope, $http, user, periodoService, curso, encuesta) {
	...
	$scope.getEncuestasCurso = function () {
		if (curso.getID() != undefined) {
			$http({
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getEncuestasCurso.php',
				method: 'POST',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.getResultadosEncuesta = function (ide) {
		...
		if (ide != undefined) {
			$http({
				method: 'POST',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getResultadosEncuesta.php',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.exportarResultados = function () {
		if (curso.getID() != undefined && encuesta.getID() != undefined) {
			window.open('http://localhost/Residencia/ActualizacionDocente/php/getFormatoResultadosEncuesta.php?ide=' + encuesta.getID() + '&idc=' + curso.getID(), '_blank');
		}
	}
...
app.controller('cursosJCtrl', function ($scope, $http, $location, user, curso, periodoService, $timeout, encuesta, encuestaService) {
	...
	$scope.crearCurso = function (datos) {
		...
		if (
			...
			$http({
				method: 'POST',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/crearCursoJ.php',
				headers: {
					'Content-Type': 'application/json'
				},
				data: JSON.stringify(datos)
	...
	$scope.actualizarCurso = function (datos) {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/actualizarCursoJ.php',
			headers: {
				'Content-Type': 'application/json'
			},
			data: JSON.stringify(datos)
	...
	$scope.getDepartamento = function () {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getDepartamento.php',
			headers: {
				'Content-type': 'application/x-www-form-urlencoded'
			},
	...
	$scope.getNuevoFolio = function () {
		...
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getNuevoFolioJ.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
			data: 'idDepartamento=' + id
...
app.controller('encuestaJCtrl', function ($scope, $http, $location, user, curso, encuesta, periodoService, fechaService, $timeout, encuestaService) {
	...
	$scope.enviar = function () {
		...
		if (Object.keys($scope.listaRespuestas).length == ($scope.preguntas).length) {
			$http({
				method: 'POST',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/registrarRespuestasEncuesta.php',
				headers: {
					'Content-type': 'json/application'
				},
				data: JSON.stringify(datos)
...
app.controller('instructoresJCtrl', function ($scope, $http, $location, user, periodoService, instructor, $timeout) {
	...
	$scope.getInstructores = function () {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getInstructoresDepartamento.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
			data: 'idDepartamento=' + user.getIdDepartamento()
...
app.controller('cursosDCtrl', function ($scope, $http, $location, user, curso, encuesta, periodoService, $timeout, fechaService, encuestaService) {
	...
	$scope.getCursos = function () {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getCursosDocenteDpto.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
			data: 'idDepartamento=' + user.getIdDepartamento()
	...
	$scope.salirCurso = function (id) {
		...
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/salirCurso.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
	...
	$scope.inscribirCurso = function (id) {
		...
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/inscribirCurso.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
			data: 'idCurso=' + id + '&idUsuario=' + $scope.idUsuario
	...
	$scope.getMisCursos = function () {
		...
		if ($scope.id != undefined) {
			$http({
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getMisCursos.php',
				method: 'POST',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.getMisCursosConcluidos = function () {
		...
		if ($scope.id != undefined) {
			$http({
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getMisCursosConcluidos.php',
				method: 'POST',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.getAsistenciaCurso = function () {
		if (curso.getID != undefined && user.getIdUsuario() != undefined) {
			$http({
				method: 'POST',
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getAsistenciaUsuarioCurso.php',
				headers: {
					'Content-type': 'application/x-www-form-urlencoded'
				},
...
app.controller('constanciasDCtrl', function ($scope, $http, $location, user, curso, periodoService, constancia) {
	...
	$scope.getConstancias = function () {
		...
		if ($scope.id != undefined) {
			$http({
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getMisConstancias.php',
				method: 'POST',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
...
app.controller('usuariosACtrl', function ($scope, $http, $location, user, periodoService, usuario, $timeout) {
	...
	$scope.getUsuarios = function () {
		$http({
			method: 'GET',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getUsuarios.php'
		}).then(function successCallback(response) {
	...
	$scope.getRoles = function () {
		$http({
			method: 'GET',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getRoles.php'
		}).then(function successCallback(response) {
	...
	$scope.agregarUsuario = function (datos) {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/agregarUsuario.php',
			headers: {
				'Content-Type': 'application/json'
			},
			data: JSON.stringify(datos)
	...
	$scope.deleteUsuario = function (id, nombreUsuario) {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/deleteUsuario.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
			data: 'idUsuario=' + id
	...
	$scope.getUsuarioAct = function () {
		...
		if (usuario.getID() != "") {
			$http({
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getUsuarioAct.php',
				method: 'POST',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.actualizarUsuario = function () {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/actualizarUsuario.php',
			headers: {
				'Content-Type': 'application/json'
			},
...
app.controller('departamentosACtrl', function ($scope, $http, $location, user, periodoService, departamento, $timeout) {
	...
	$scope.getUsuarios = function () {
		$http({
			method: 'GET',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/getUsuariosDis.php'
		}).then(function successCallback(response) {
			$scope.usuarios = response.data;
		});
	}
	...
	$scope.agregarDepartamento = function (datos) {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/agregarDepartamento.php',
			headers: {
				'Content-Type': 'application/json'
			},
			data: JSON.stringify(datos)
	...
	$scope.deleteDepartamento = function (id, nombreDepartamento) {
		$http({
			method: 'POST',
			url: 'http://localhost/Residencia/ActualizacionDocente/php/deleteDepartamento.php',
			headers: {
				'Content-Type': 'application/x-www-form-urlencoded'
			},
			data: 'idDepartamento=' + id
	...
	$scope.getDepartamentoAct = function () {
		...
		if (departamento.getID() != "") {
			$http({
				url: 'http://localhost/Residencia/ActualizacionDocente/php/getDepartamentoAct.php',
				method: 'POST',
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded'
				},
	...
	$scope.actualizarDepartamento = function (data) {
		$http({
			url: 'http://localhost/Residencia/ActualizacionDocente/php/actualizarDepartamento.php',
			method: 'POST',
			headers: {
				'Content-Type': 'application/json'
			},
